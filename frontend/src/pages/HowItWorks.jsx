    ...
    <div style={{ background: '#fff', fontFamily: "'Google Sans', 'Roboto', system-ui, sans-serif", color: '#202124' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0' }}>
          {steps.map((step, i) => (
            <motion.div key={i} initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-60px' }} variants={fadeUp}>
              <div 
                style={{ display: 'grid', gridTemplateColumns: i % 2 === 0 ? '1fr 1fr' : '1fr 1fr', gap: '80px', alignItems: 'center', padding: '80px 0', borderBottom: i < steps.length - 1 ? '1px solid #f0f2f5' : 'none' }}
                className="step-row"
              >
                {/* Text side */}
      ...
      <style>{`
        @media (max-width: 1024px) {
          .step-row { grid-template-columns: 1fr !important; gap: 40px !important; padding: 48px 0 !important; }
        ...
        @media (max-width: 768px) {
          ...
          .step-row h2 { font-size: 1.6rem !important; }
          .step-row p { font-size: 0.95rem !important; }
          .step-row div[style*="padding: '60px'"] { padding: 32px !important; }
