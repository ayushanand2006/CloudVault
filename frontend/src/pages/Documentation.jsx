    ...
    return (
        <MainLayout>
            <div style={{ position: 'relative', display: 'flex', background: '#ffffff' }}>
                {/* Sidebar */}
                <div style={{ width: '300px', height: 'calc(100vh - 80px)', background: '#f8fafc', borderRight: '1px solid rgba(0,0,0,0.05)', padding: '40px', position: 'sticky', top: '80px' }}>
                ...
                {/* Content */}
                <div style={{ flex: 1, padding: '100px 8%', maxWidth: '1000px', color: '#0f172a' }}>
                    ...
                    <div style={{ padding: '60px', background: '#f8fafc', borderRadius: '40px', border: '1px solid rgba(0,0,0,0.05)', marginBottom: '60px' }}>
                        <h2 style={{ fontSize: '2rem', fontWeight: '800', marginBottom: '30px' }}>Quick Installation</h2>
                        <div style={{ background: '#0f172a', padding: '25px', borderRadius: '16px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', fontFamily: 'monospace', fontSize: '1.1rem' }}>
